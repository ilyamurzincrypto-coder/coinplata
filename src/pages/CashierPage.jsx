    ...
    <main className="min-h-screen">
      {isDashboard && (
        ...
        >
          ...
          {/* 324px — ширина колонки курсов из эталона (r12, grid-main). Живые
              258px были молчаливым расхождением и дважды прикидывались
              проблемой механик: в r12 ховер-расшифровке не хватало 28–35px до
              первого числа, в r14 мини-сводка кросса влезала на треть. */}
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(240px,324px)_1fr] items-start">
