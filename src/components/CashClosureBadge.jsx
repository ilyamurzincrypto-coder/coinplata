  ...
  return (
    <>
      <button
        ...
        className="group inline-flex items-center gap-2 px-3 py-1.5 rounded-card border border-border-soft bg-white text-ink hover:border-border hover:shadow-sm transition-all duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)]"
      >
