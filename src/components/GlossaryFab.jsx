        ...
        >
          ...
          >
            <header className="px-4 py-3 border-b border-border-soft flex items-center gap-2">
              ...
              <h3 className="text-body font-bold text-ink flex-1">Глоссарий</h3>
              <span className="hidden sm:inline-flex items-center text-tiny font-medium text-muted-soft">
            ...
            <div className="px-3 pt-3 pb-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-surface-soft border border-border-soft focus:border-accent focus:ring-4 focus:ring-accent/10 rounded-card pl-8 pr-3 py-2 text-body-sm outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-3 pb-3 pt-1 space-y-1.5">
              {results.length === 0 ? (
                <div className="text-center py-10 text-caption text-muted-soft">
                ...
                results.map((t, i) => (
                  ...
                  >
                    <div className="flex items-baseline gap-2 flex-wrap">
                      ...
                      {t.aliases.length > 0 && (
                        <span className="text-tiny text-muted-soft font-medium">
                          (
                          {t.aliases.map((a, k) => (
                    ...
                    {t.definition && (
                      <div className="text-caption text-ink-soft mt-1 leading-snug">
            ...
            <footer className="px-3 py-2 border-t border-border-soft flex items-center gap-2 bg-surface-soft/40">
              ...
              {onOpenInfo && (
                <button
                  ...
                  className="ml-auto inline-flex items-center gap-1 text-caption font-semibold text-accent hover:text-accent"
                >
                  Полная справка
