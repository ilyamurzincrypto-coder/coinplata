...
export default function RateChangeBanner() {
  ...
  return (
    <div className="sticky top-16 z-30 bg-warning-soft border-b border-warning/20 shadow-[0_2px_8px_-4px_rgba(245,158,11,0.25)] animate-[slideDown_180ms_ease-out]">
