    ...
    <div className="border-t border-border-soft">
      ...
      <div className="px-3 py-2.5 flex items-center gap-2 border-t border-border-soft bg-surface-soft/30">
        <button
          type="button"
          onClick={() => onAddLeg("in")}
          className="inline-flex items-center gap-1 px-2.5 py-1 rounded-[var(--radius-cell)] bg-success-soft hover:bg-emerald-100 border border-success/20 text-success text-tiny font-bold uppercase tracking-wider"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1 px-2.5 py-1 rounded-[var(--radius-cell)] bg-danger-soft hover:bg-rose-100 border border-danger/20 text-danger text-tiny font-bold uppercase tracking-wider"
        >
          <Plus className="w-3 h-3" />
