...
// Раньше USDT↔USD показывали процентом (маржа на ~1:1). Но процент — это спред,
// а не курс: на информативной панели нужен нормальный курс числом. Поэтому
// процентное ОТОБРАЖЕНИЕ отключено (пусто). Ввод процентом при пасте всё ещё
// работает — парсер реагирует на знак «%» (hasPct), а не на эту константу.
export const PERCENT_CCYS = [];
