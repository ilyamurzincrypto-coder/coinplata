  ...
  theme: {
    extend: {
      colors: {
        ...
        // ── Табачные рабочие таблицы (эталон r6: .deals / .wal) ───────
        "surface-apps":  "#F7F1E1",  // фон табачной секции (заявки, ведомость кошельков)
        "apps-group":    "#F0E8D3",  // строка-группа внутри табачной таблицы
        "apps-line":     "#E8DFC8",  // горизонтальная линия строки
        "apps-line-v":   "#EFE7D3",  // вертикальный разделитель колонок
        "apps-line-h":   "#D9CFB2",  // линия под шапкой таблицы
        "apps-muted":    "#99916F",  // подписи/шапка в табачной таблице
        "apps-warn":     "#B07A3C",  // оранжевая пометка группы (офис неактивен)
